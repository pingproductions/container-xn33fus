...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xn33fus.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xn33fus.containers.anotherwebservice.com/
...
```
git clone git@github.com:pingproductions/container-xn33fus.git
cd container-xn33fus
```
...
```
docker attach container-xn33fus
```
